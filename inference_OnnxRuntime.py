...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str,default='RealESRGAN_x4plus.onnx', help='specify onnx model path')
    ...
    parser.add_argument('--output_path', type=str,default='inputs/anh1.jpg' , help='specify output model path')
